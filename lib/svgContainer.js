...
export function svgContainer({
  ...
  const svgEffectiveWidth = Math.max(...componentWidths, width); // fallback to 350
  ...
  let currentY = titleHeight + spacing + titlePaddingBottom;
