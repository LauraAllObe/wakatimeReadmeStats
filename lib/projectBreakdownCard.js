  ...
  const chartSvgBlocks = (() => {
    ...
    case 'area': {
      ...
      case 'radar': {
        ...
        console.log("Radar legend color for first item:", allProjects[0], projectColors[allProjects[0]]);
        ...
        const legendItems = allProjects.map((project, i) => {
          ...
          return `
            <text x="${x}" y="${y}" font-size="10" font-weight="bold" fill="#${text_color}">${project}</text>
